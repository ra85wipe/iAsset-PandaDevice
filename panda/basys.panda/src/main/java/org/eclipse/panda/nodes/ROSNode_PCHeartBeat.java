 ...
 ********************************************************************************************************/
public class ROSNode_PCHeartBeat implements NodeMain {
	...
	public void onStart(ConnectedNode connectedNode) {
		...
		Subscriber<std_msgs.String> subscriberHeartBeat = connectedNode.newSubscriber(ROS_TOPIC_PANDA_PC_HEARTBEAT, std_msgs.String._TYPE);
